...
namespace Util.IO {
    ...
    public sealed class LineReader : IEnumerable<string> {
        ...
        public LineReader(Func<Stream> streamSource) : this(streamSource, Encoding.UTF8) {}
        ...
        public LineReader(string filename) : this(filename, Encoding.UTF8) {}
        ...
        public LineReader(string filename, Encoding encoding) : this(() => new StreamReader(filename, encoding)) {}
