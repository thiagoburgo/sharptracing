...
namespace DrawEngine.Renderer.BasicStructures {
    ...
    public struct RGBColor : IEquatable<RGBColor> {
        ...
        {
            get {
                return (0.2989f * red) + (0.5866f * green) + (0.1145f * blue);
            }
        }
        public float Max {
            get {
        ...
        public float Average {
            get { return ((this.red + this.green + this.blue) / 3f); }
        }
        public float Sum {
            get { return (this.red + this.green + this.blue); }
        }
        public RGBColor Normalized {
            get {
                RGBColor temp = new RGBColor(this.red, this.green, this.blue);
                temp.Normalize();
                return temp;
            }
        }
