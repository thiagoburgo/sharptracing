...
namespace DrawEngine.Renderer.RenderObjects {
    ...
    public class Polygon : Primitive, IPreprocess, ITransformable3D {
        ...
        public virtual void Preprocess() {
            ...
            if (this.normal.Length.NearZero()) {
        ...
        protected virtual bool IsCoplanar {
            get {
                ...
                for (int i = 1; i < this.vertices.Count - 2; i++) {
                    ...
                    if (!ni.X.IsEqual(n0.X) || !ni.Y.IsEqual(n0.Y) || !ni.Z.IsEqual(n0.Z)) {
                        return false;
                    }
                }
                return true;
        ...
        public virtual void Rotate(float angle, Vector3D axis) {
        ...
        public virtual void RotateAxisX(float angle) {
            this.Rotate(angle, Vector3D.UnitX);
        }

        public virtual void RotateAxisY(float angle) {
            this.Rotate(angle, Vector3D.UnitY);
        }

        public virtual void RotateAxisZ(float angle) {
        ...
        public virtual void Translate(Vector3D translateVector) {
