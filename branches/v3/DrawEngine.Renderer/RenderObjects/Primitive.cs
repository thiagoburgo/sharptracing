...
namespace DrawEngine.Renderer.RenderObjects {
    ...
    [XmlInclude(typeof (Torus)), XmlInclude(typeof (Triangle)), XmlInclude(typeof (Box)), XmlInclude(typeof (Cone)),
     XmlInclude(typeof (Cylinder)), XmlInclude(typeof (Disc)), XmlInclude(typeof (Ellipsoid)),
     XmlInclude(typeof (Plane)), XmlInclude(typeof (Quadrilatero)), XmlInclude(typeof (Sphere)),
     XmlInclude(typeof (TriangleModel)), XmlInclude(typeof (Polygon)), XmlInclude(typeof (RegularPolygon)),
     XmlInclude(typeof (SphereFlake)), XmlInclude(typeof (CubeFlake)), XmlInclude(typeof (CornellBox)), Serializable]
    ...
    public abstract class Primitive : IPrimitive, INameable {
        ...
        [XmlIgnore, NonSerialized] protected Material material;
        private String name;
