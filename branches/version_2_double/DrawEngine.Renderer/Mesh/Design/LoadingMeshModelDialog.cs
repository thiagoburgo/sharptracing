...
namespace DrawEngine.Renderer.Mesh.Design
{
    ...
    public partial class LoadingMeshModelDialog : Form
    {
        ...
        private void MeshModel_OnElementLoaded(int percentageOfTotal, DrawEngine.Renderer.Mesh.Importers.ElementMesh element)
        {
            ...
            switch (element)
            {
                case DrawEngine.Renderer.Mesh.Importers.ElementMesh.Vertex:
                    name = "Vertices";
                    break;
                case DrawEngine.Renderer.Mesh.Importers.ElementMesh.VextexIndice:
                    name = "Triangles";
                    break;
                case DrawEngine.Renderer.Mesh.Importers.ElementMesh.VertexNormal:
