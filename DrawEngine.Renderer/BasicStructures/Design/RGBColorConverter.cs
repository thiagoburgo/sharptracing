                ...
                if(text2.IndexOf(ch1) == -1){
                    if(((text2.Length >= 2) && ((text2[0] == '\'') || (text2[0] == '"')))
                       && (text2[0] == text2[text2.Length - 1])){
                        ...
                        obj1 =
                                Color.FromArgb(-16777216
                                               | ((int)converter1.ConvertFromString(context, culture, text2)));
                    }
                }
                if(obj1 == null){
            ...
            if(value is Color){
                ...
                if(destinationType == typeof(InstanceDescriptor)){
                    ...
                    if(color2.IsEmpty){
                        ...
                        info1 = typeof(Color).GetMethod("FromArgb", new Type[]{typeof(int), typeof(int), typeof(int)});
