...
namespace DrawEngine.Renderer.BasicStructures
{
    ...
    public struct RGBColor : IEquatable<RGBColor>
    {
        ...
        {
            RGBColor retorno = new RGBColor(rgb1.r + rgb2.r, rgb1.g + rgb2.g, rgb1.b + rgb2.b);
            return retorno;
        }
        public static RGBColor operator -(RGBColor rgb1, RGBColor rgb2)
        {
        ...
        {
            RGBColor retorno = new RGBColor(escalar * rgb.r, escalar * rgb.g, escalar * rgb.b);
            return retorno;
        }
        ...
        {
            RGBColor retorno = new RGBColor(rgb1.r * rgb.r, rgb1.g * rgb.g, rgb1.b * rgb.b);
            return retorno;
        }
        public static RGBColor operator /(RGBColor rgb, float scalar)
        {
            RGBColor retorno = new RGBColor(rgb.r * (1 / scalar), rgb.g * (1 / scalar), rgb.b * (1 / scalar));
            return retorno;
        }
        public override string ToString()
        {
